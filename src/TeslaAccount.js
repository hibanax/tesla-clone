        ...
        <div className="teslaAccount">
            <div className="teslaAccount__header">
                ...
                <div className="teslaAccount__links">
                    ...
                    <Link to="/teslaaccount">Model Solar Roof</Link>
                    <Link to="/teslaaccount">Model Solar Panels</Link>
                    ...
                    <div 
                        ...
                        >
                        {isMenuOpen ? (<CloseIcon className="teslaAccount__closeMenu" />
                         ) : (
                        <MenuIcon />
                        )}
                    </div>
           ...
           <div className="teslaAccount_car">
               ...
               <Car imgSrc="https://www.tesla.com/tesla_theme/assets/img/mytesla/v3/header-nocar-modelx@2x.jpg?20170815" model="Model X" testDrive="test drive" />
               <Car imgSrc="https://crdms.images.consumerreports.org/c_lfill,w_768,q_auto,f_auto/prod/cars/chrome/white/2020TSS020008_1280_03" model="Model Y" testDrive="test drive" />
           </div>
